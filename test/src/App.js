...
<div className="page__content">
      <header className="header">
        <img className="header__logo" src="images/Vector.svg"
      ...
      <main>
        <section className="profile">
          <div className="profile__container">
            ...
            <button className="profile__image-button" type="button">
              ...
              alt="edit-button" className="profile__image-button-vector" />
            </button>
          </div>
          <div className="profile__description">
            <div className="profile__caption">
              ...
              <button className="profile__edit-button" type="button">
                <img src="images/edit-button.svg"
                alt="edit-button" className="profile__edit-button-vector" />
              </button>
            </div>
            <p className="profile__subtitle">Explorer</p>
          </div>
          <button className="profile__button" type="button">
            <img src="images/Plus-vector.svg" alt="plus-emoji"
        ...
        <div className="popup popup_type_card">
          <div className="popup__content">
            ...
            <form className="popup__form popup__form_type_card" name="card-form">
              ...
              <button type="submit" className="popup__submit-button" id="save-button-card">Create</button>
            </form>
          </div>
        </div>
        ...
        <div className="popup popup_type_avatar">
          ...
          <button type="submit" className="popup__submit-button" id="save-button-avatar">Save</button>
            </form>
          </div>
        </div>
